...
<img src=".assets/TAExample.png" alt="腹部截断伪影" width=30% />
...
<img src=".assets/sgm_padding.png" alt="正弦图" width=30%/> <img src=".assets/padding_compare.png" alt="padding比较" width=50%/>

- padding 单侧长度一般为正弦图宽度的 10% (RTK)。
- 对 padding 后的正弦图进行重建，并根据探测器成像几何，裁剪出原来探测器视野FOV即可。

<img src=".assets/padding_recon.png" width=30% /><img src=".assets/recon_crop.png" alt="recon_crop" width=30% />
